...
import Stars from './components2/Stars'
...
export default function page() {
  return (
    ...
    // <div>
    //   <h1 className="text-[50px]">this is my first line in react</h1>
    // </div>
  )
}
